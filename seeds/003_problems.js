  ...
  return knex('problems').del()
    .then(() => {
      ...
      return knex('problems').insert([
        ...
        {id: 4, age:32, gender_id:4, race_id:1, lat:'1.000143', long:'43.99999465', type_id:4, other:null, viewpoint:'happen', noun:'all restaurants and offices', action:'be required to use compostable or recyclable packaging', reason:'we would put less plastic and styrofoam into the landfills', story:'we would put less plastic and styrofoam into the landfills'},
